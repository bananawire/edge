        ...
        "schemas": {
            "CreateTelemetryRequest": {
                ...
                "properties": {
                    ...
                    "reading_id": {"type": "string", "format": "uuid", "description": "Stable sample identity generated by the firmware (contract v1)."},
                    "measured_at": {"type": "string", "format": "date-time", "description": "Measurement instant with UTC offset (contract v1)."},
                },
            },
            "TelemetryResponse": {
                "type": "object",
